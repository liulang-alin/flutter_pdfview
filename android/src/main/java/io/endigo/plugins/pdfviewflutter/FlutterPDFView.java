...
import android.src.main.java.io.endigo.plugins.pdfviewflutter.pdfviewer.PDFView;
...
import android.src.main.java.io.endigo.plugins.pdfviewflutter.pdfviewer.scroll.DefaultScrollHandle;
...
public class FlutterPDFView implements PlatformView, MethodCallHandler {
    ...
    private static final int PASSWORD_ERROR = 100;
        ...
        if (config != null) {
            config
                ...
                public void onError(Throwable t) {
                    ...
                    errorArgs.put("errorMsg", t.toString());
                    if (t instanceof PdfPasswordException) {
                        errorArgs.put("code", PASSWORD_ERROR);
                    }
